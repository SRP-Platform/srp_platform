 ...
 *
 */
#ifndef EXAMPLE_APP_EXAMPLEAPP_CODE_APPLICATION_EXAMPLE_SERVICE_H_
#define EXAMPLE_APP_EXAMPLEAPP_CODE_APPLICATION_EXAMPLE_SERVICE_H_
#include <map>
...
class MyExampleService : public srp::example::ExampleServiceSkeleton {
 ...
 protected:
  ...
  ara::core::Result<srp::example::ExampleDataStructure> SetStatus4() override {
...
#endif  // EXAMPLE_APP_EXAMPLEAPP_CODE_APPLICATION_EXAMPLE_SERVICE_H_
