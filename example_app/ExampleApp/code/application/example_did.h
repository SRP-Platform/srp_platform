 ...
 *
 */
#ifndef EXAMPLE_APP_EXAMPLEAPP_CODE_APPLICATION_EXAMPLE_DID_H_
#define EXAMPLE_APP_EXAMPLEAPP_CODE_APPLICATION_EXAMPLE_DID_H_
...
#endif  // EXAMPLE_APP_EXAMPLEAPP_CODE_APPLICATION_EXAMPLE_DID_H_
