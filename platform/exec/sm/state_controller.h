 ...
 *
 */
#ifndef PLATFORM_EXEC_SM_STATE_CONTROLLER_H_
#define PLATFORM_EXEC_SM_STATE_CONTROLLER_H_
#include <memory>
...
class StateController final : public IStateController {
 ...
 public:
   ...
   *
   * @pplatformm state unique_ptr with new state
   * @return int8_t 0 - OK
   */
...
#endif  // PLATFORM_EXEC_SM_STATE_CONTROLLER_H_
