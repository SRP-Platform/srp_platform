 ...
 * 
 */
#ifndef PLATFORM_EXEC_SM_I_STATE_CONTROLLER_H_
#define PLATFORM_EXEC_SM_I_STATE_CONTROLLER_H_

#include <cstdint>
#include <memory>

#include "platform/exec/sm/i_state.h"
...
class IStateController {
 ...
 public:
   ...
   *
   * @pplatformm new_state_id id of new state
   * @return int8_t 0 - OK
   */
   ...
   *
   * @pplatformm state shared_ptr with new state
   * @return int8_t 0 - OK
   */
   ...
   *
   * @pplatformm event_value new state
   */
...
#endif  // PLATFORM_EXEC_SM_I_STATE_CONTROLLER_H_
