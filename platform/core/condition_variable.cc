...
platform::core::Result<void> ConditionVariableProxy::Find() {
  {
...
platform::core::Result<void> ConditionVariableProxy::NotifyOne() {
  if (shm_object_ == nullptr) {
    return MakeErrorCode(platform::core::CoreErrc::kInvalidArgument, "");
  }
...
platform::core::Result<void> ConditionVariableProxy::NotifyAll() {
  if (shm_object_ == nullptr) {
    return MakeErrorCode(platform::core::CoreErrc::kInvalidArgument, "");
  }
  pthread_mutex_lock(&shm_object_->mutex_);
...
platform::core::Result<void> ConditionVariableSkeleton::Offer() {
  {
...
platform::core::Result<void> ConditionVariableSkeleton::NotifyOne() {
  if (shm_object_ == nullptr) {
    return MakeErrorCode(platform::core::CoreErrc::kInvalidArgument, "");
  }
  pthread_mutex_lock(&shm_object_->mutex_);
...
platform::core::Result<void> ConditionVariableSkeleton::NotifyAll() {
  if (shm_object_ == nullptr) {
    return MakeErrorCode(platform::core::CoreErrc::kInvalidArgument, "");
  }
  pthread_mutex_lock(&shm_object_->mutex_);
