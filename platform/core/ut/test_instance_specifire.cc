...
// Pplatformmetryzowane testy dla operatorów porównania i metod
class InstanceSpecifierTest : public ::testing::TestWithPplatformm<std::tuple<StringView, StringView, bool>> {};

TEST_P(InstanceSpecifierTest, EqualityOperator) {
    StringView identifier1 = std::get<0>(GetPplatformm());
    StringView identifier2 = std::get<1>(GetPplatformm());
    bool expectedEquality = std::get<2>(GetPplatformm());
...
// Pplatformmetryzowane testy dla funkcji Create
class CreateInstanceSpecifierTest : public ::testing::TestWithPplatformm<std::tuple<StringView, bool, StringView>> {};

TEST_P(CreateInstanceSpecifierTest, CreateWithValidIdentifier) {
    StringView identifier = std::get<0>(GetPplatformm());
    bool expectedHasValue = std::get<1>(GetPplatformm());
    StringView expectedValue = std::get<2>(GetPplatformm());
...
// Definicja zestawu danych dla pplatformmetrów
