 ...
 * 
 */
#ifndef PLATFORM_LOG_LOGGER_H_
#define PLATFORM_LOG_LOGGER_H_
...
class Logger {
 ...
 public:
  ...
  /// context or not
  /// @pplatformm logLevel Input log severity level
  ...
  /// @pplatformm ctxId Context ID
  /// @pplatformm ctxDescription Context description
  /// @pplatformm ctxDefLogLevel Context default log level
