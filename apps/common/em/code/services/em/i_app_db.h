 ...
 *
 */
#ifndef APPS_COMMON_EM_CODE_SERVICES_EM_I_APP_DB_H_
#define APPS_COMMON_EM_CODE_SERVICES_EM_I_APP_DB_H_
...
class IAppDb {
 public:
   ...
   *
   * @pplatformm fg_id functional group id
   * @pplatformm name functional group name
   * @return int8_t 0 = OK
   */
   ...
   *
   * @pplatformm app_id App ID from config file
   * @pplatformm pid new PID
   */
   ...
   *
   * @pplatformm app_id_ App ID for which we want config
...
#endif  // APPS_COMMON_EM_CODE_SERVICES_EM_I_APP_DB_H_
