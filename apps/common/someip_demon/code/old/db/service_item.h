 ...
 * 
 */
#ifndef APPS_COMMON_SOMEIP_DEMON_CODE_DB_SERVICE_ITEM_H_
#define APPS_COMMON_SOMEIP_DEMON_CODE_DB_SERVICE_ITEM_H_
#include <cstdint>
...
#endif  // APPS_COMMON_SOMEIP_DEMON_CODE_DB_SERVICE_ITEM_H_
