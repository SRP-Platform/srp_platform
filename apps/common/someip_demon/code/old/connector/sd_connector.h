 ...
 *
 */
#ifndef APPS_COMMON_SOMEIP_DEMON_CODE_CONNECTOR_SD_CONNECTOR_H_
#define APPS_COMMON_SOMEIP_DEMON_CODE_CONNECTOR_SD_CONNECTOR_H_
#include <memory>
...
#include "apps/common/someip_demon/code/connector/common_connector.h"
#include "apps/common/someip_demon/code/connector/i_db.h"
#include "apps/common/someip_demon/code/db/database.h"
namespace srp {
...
class SDConnector : public CommonConnector, public IDb {
 ...
 private:
  ...
  void AddNewOfferService(const apps::com::someip::ServiceEntry& entry,
                          const uint32_t pid);
  void AddNewFindService(const apps::com::someip::ServiceEntry& entry,
                         const uint32_t pid);
  void SdMsgHandler(const uint32_t pid,
                    const apps::com::someip::SomeipFrame& frame);
 ...
 public:
  void ProcessFrame(uint32_t pid,
                    apps::com::someip::SomeipFrame&& frame) noexcept override;
...
#endif  // APPS_COMMON_SOMEIP_DEMON_CODE_CONNECTOR_SD_CONNECTOR_H_
