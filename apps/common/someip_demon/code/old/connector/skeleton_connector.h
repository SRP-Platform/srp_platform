 ...
 * 
 */
#ifndef APPS_COMMON_SOMEIP_DEMON_CODE_CONNECTOR_SKELETON_CONNECTOR_H_
#define APPS_COMMON_SOMEIP_DEMON_CODE_CONNECTOR_SKELETON_CONNECTOR_H_
#include <memory>
...
class SkeletonConnector : public CommonConnector {
 private:
  ...
  void SendResult(const ReqDetails& det, platform::com::someip::SomeipFrame frame);

 public:
  void ProcessFrame(uint32_t pid,
                    platform::com::someip::SomeipFrame&& frame) noexcept override;
...
#endif  // APPS_COMMON_SOMEIP_DEMON_CODE_CONNECTOR_SKELETON_CONNECTOR_H_
