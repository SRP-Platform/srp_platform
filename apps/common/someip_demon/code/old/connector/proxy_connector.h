 ...
 *
 */
#ifndef APPS_COMMON_SOMEIP_DEMON_CODE_CONNECTOR_PROXY_CONNECTOR_H_
#define APPS_COMMON_SOMEIP_DEMON_CODE_CONNECTOR_PROXY_CONNECTOR_H_
#include <memory>
#include <string>
...
#endif  // APPS_COMMON_SOMEIP_DEMON_CODE_CONNECTOR_PROXY_CONNECTOR_H_
