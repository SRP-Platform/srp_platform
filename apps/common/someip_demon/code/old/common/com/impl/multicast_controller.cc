 ...
 *
 */
#include "apps/common/someip_demon/code/common/com/impl/multicast_controller.h"
...
MulticastController::MulticastController(const std::string& interface_ip,
    ...
    : interface_ip_{interface_ip},
      ...
      logger_{platform::log::LoggingMenager::GetInstance()->CreateLogger(
          "mUDP", "", platform::log::LogLevel::kError)} {}
...
platform::core::Result<void> MulticastController::Start() noexcept {
...
platform::core::Result<void> MulticastController::SendFrame(
