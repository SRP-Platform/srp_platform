 ...
 * 
 */
#ifndef APPS_COMMON_SOMEIP_DEMON_CODE_COMMON_COM_IMPL_MULTICAST_CONTROLLER_H_
#define APPS_COMMON_SOMEIP_DEMON_CODE_COMMON_COM_IMPL_MULTICAST_CONTROLLER_H_
...
class MulticastController : public IMulticastController {
 ...
 public:
  ...
  ~MulticastController();
  platform::core::Result<void> Start() noexcept override;
  void Stop() noexcept override;
  platform::core::Result<void> SendFrame(const std::vector<uint8_t>& data,
                                    const std::string& ip,
...
#endif  // APPS_COMMON_SOMEIP_DEMON_CODE_COMMON_COM_IMPL_MULTICAST_CONTROLLER_H_
