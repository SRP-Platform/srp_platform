 ...
 * 
 */
#ifndef APPS_COMMON_SOMEIP_DEMON_CODE_COMMON_I_NETWORK_CONTROLLER_H_
#define APPS_COMMON_SOMEIP_DEMON_CODE_COMMON_I_NETWORK_CONTROLLER_H_
#include <cstdint>
#include <memory>
#include <string>
#include <vector>
...
#endif  // APPS_COMMON_SOMEIP_DEMON_CODE_COMMON_I_NETWORK_CONTROLLER_H_
