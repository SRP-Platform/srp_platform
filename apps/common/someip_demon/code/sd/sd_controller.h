 ...
 * 
 */
#ifndef APPS_COMMON_SOMEIP_DEMON_CODE_SD_SD_CONTROLLER_H_
#define APPS_COMMON_SOMEIP_DEMON_CODE_SD_SD_CONTROLLER_H_
...
#include "platform/com/someip/someip_sd_frame_builder.h"
...
class SdController : public common::IController {
 ...
 public:
  ...
  void ProcessFrame(
      ...
      const platform::com::someip::SomeipFrame& frame) noexcept override;
  SdController(
...
#endif  // APPS_COMMON_SOMEIP_DEMON_CODE_SD_SD_CONTROLLER_H_
