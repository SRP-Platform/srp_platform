...
namespace ara {
namespace exec {
class ExecutionClient : public ara::com::IComClient, public IExecutionClient {
 private:
  uint32_t app_id_{0};

 public:
  ara::core::Result<void> ReportExecutionState(
      const ExecutionState state) const noexcept override;
  ExecutionClient();
  ...
  static std::shared_ptr<ExecutionClient> GetInstance(
