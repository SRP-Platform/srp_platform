...
from tools.model_generator.platform.interface.interface_proxy_extractor import InterfaceProxyExtractor
from tools.model_generator.platform.interface.interface_skeleton_extractor import InterfaceSkeletonExtractor
...
if __name__ == "__main__":
    ...
    for p_model in skeleton_list:
         CreateDir(copy.copy(out_path),p_model.package[1:])
         InterfaceSkeletonExtractor.ExtractSkeleton(copy.copy(out_path),p_model)