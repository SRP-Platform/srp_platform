...
ara_json2config = rule(
    ...
    attrs = {
        ...
        "tool": attr.label(
            ...
            cfg = "exec",
            allow_files = True,
            default = Label("//tools/model_generator/ara:json2config"),
        ),
    },
)
...
ara_json2runtime_env = rule(
    ...
    attrs = {
        ...
        "tool": attr.label(
            ...
            cfg = "exec",
            allow_files = True,
            default = Label("//tools/model_generator/ara:json2runtime_env"),
        ),
    },
)
...
ara_json2someip_lib = rule(
    ...
    attrs = {
        ...
        "tool": attr.label(
            ...
            cfg = "exec",
            allow_files = True,
            default = Label("//tools/model_generator/ara:json2someip_lib"),
        ),
    },
)
...
def ara_someip_lib(name, model_src, visibility = []):
    ...
    native.cc_library(
        name = name,
        deps = ["//ara/com:com_error_domain", "//ara/core:Result", "//ara/com/someip:someip_lib","//core/data:data_conv_lib"],
        srcs = [":someip_src"],
