...
ara_json2sm_code = rule(
    ...
    attrs = {
        ...
        "tool": attr.label(
            ...
            cfg = "exec",
            allow_files = True,
            default = Label("@srp_platform//tools/model_generator/ara:json2sm_code"),
        ),
    },
)
...
ara_json2sm_config = rule(
    ...
    attrs = {
        ...
        "tool": attr.label(
            ...
            cfg = "exec",
            allow_files = True,
            default = Label("@srp_platform//tools/model_generator/ara:json2sm_config"),
        ),
    },
)
