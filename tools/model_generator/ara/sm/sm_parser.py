import json
from tools.model_generator.ara.sm.state import State, SwitchTransition, EmptyTransition, Transition, Mode, DtcTransition, MultipleTransition
from tools.model_generator.ara.sm.db import DB
class SmParser:
